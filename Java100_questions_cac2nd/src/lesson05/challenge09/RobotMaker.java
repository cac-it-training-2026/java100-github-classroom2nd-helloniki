...
class Robot {
	...
	String makeEggDishes(int flourNum, int sugarNum, int eggNum, int butterNum) {
		...
		if (flourNum >= 170 && sugarNum >= 50 && eggNum >= 1 && butterNum >= 80) {
			manu = "クッキー";
		} else if ((flourNum < 170 || sugarNum < 50) && eggNum >= 2 && butterNum >= 5) {
			manu = "オムレツ";
		} else {
			manu = "何も作れません。";
		}
	...
	void makeOmlet(int eggNum, int butterNum) {
		...
		System.out.println(omlet + "人分のオムレツを作成しました。");
...
public class RobotMaker {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(robot.manu + "が出来ました。");
